...
| 优先级 | 功能 | 为何有趣 |
|--------|------|----------|
| ★★★ | **任务/委托系统** | 「帮我清 3 只史莱姆」→ NPC 记忆任务状态，完成给武器/经验 |
| ★★★ | **关系解锁能力** | 信任 >60 解锁：专属 Buff、传送、商店折扣 |
| ★★☆ | **NPC 间社交** | 多个 Agent 共享「区域传闻」记忆，聊天会传播 |
| ★★☆ | **情绪/心情条** | 天气、被攻击、独处影响心情，改变台词与 patrol 半径 |
| ★★☆ | **长期记忆归档** | episodic 满后 LLM 摘要压缩为「人生经历」一条 |
| ★☆☆ | **昼夜/事件日程** | 固定时段 NPC 在不同地点有不同行为树 |
| ★☆☆ | **玩家身份标签** | 记忆提炼「常帮忙的猎人」「曾背叛者」影响所有 NPC |

核心原则：**记忆要转化为玩法反馈**（台词 + 行为 + 奖励），而不只是聊天更好看。
